...
rna_matrix <- readMM("GSE281719_matrix_rna.mtx.gz")
protein_matrix <- readMM("GSE281719_matrix_protein.mtx.gz")
...
#save(file="model_GSE301960",model)
# ---------------------------------------------------------
...
save(file="cell_factors_py_GSE281719",cell_factors_py)

#UMAP <- umap(cell_factors_py[[1]])
#save(file="UMAP_scmomat_GSE281719",UMAP)
