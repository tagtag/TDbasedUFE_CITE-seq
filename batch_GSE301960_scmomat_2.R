...
rna_matrix <- readMM("GSE301960_matrix_rna.mtx.gz")
protein_matrix <- readMM("GSE301960_matrix_protein.mtx.gz")
...
save(file="cell_factors_py_GSE301960",cell_factors_py)

#UMAP <- umap(cell_factors_py[[1]])
#save(file="UMAP_scmomat_GSE301960",UMAP)
